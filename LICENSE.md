...
Ce projet est mis à disposition selon les termes de la licence **[Creative Commons Attribution – NonCommercial 4.0 International (CC BY-NC 4.0)](https://creativecommons.org/licenses/by-nc/4.0/)**.  

[![Licence CC BY-NC 4.0](https://img.shields.io/badge/License-CC%20BY--NC%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc/4.0/)

**Résumé pour les utilisateurs :**  
- Vous pouvez **partager et adapter** ce contenu  
- Mais **uniquement à des fins non commerciales**  
- **Attribution obligatoire** : mentionner l’auteur et indiquer les modifications si vous en faites
